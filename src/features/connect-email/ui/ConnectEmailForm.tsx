              ...
              {isGmail ? (
                <div className="space-y-1">
                  ...
                  <ol className="list-decimal list-inside space-y-0.5">
                    ...
                    <li>Selecciona "Correo" → "Otro" → escribe "MisCuentas"</li>
                    <li>Copia la contraseña de 16 caracteres</li>
                  </ol>
                </div>
              ) : (
                <div className="space-y-1">
                  <p className="font-medium">Para Outlook/Hotmail:</p>
                  <ol className="list-decimal list-inside space-y-0.5">
                    <li>Ve a account.microsoft.com/security</li>
                    <li>Opciones de seguridad avanzadas</li>
                    <li>Contraseñas de aplicación → Crear nueva</li>
                  </ol>
                </div>
              )}
            </div>
