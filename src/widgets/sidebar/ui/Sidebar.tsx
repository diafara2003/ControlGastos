...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex fixed left-0 top-0 bottom-0 w-60 flex-col border-r border-gray-100 dark:border-slate-700/50 bg-[#ffffff] dark:bg-[#0f172a] z-40">
      {/* Logo */}
